!   Simple demo of a 2D line plot - parameterised line, new pages (press space)
!
...
!!  integer, parameter :: pl_test_flt = kind(1.0d0)
    ...
    !
    ! Note: advancing is not automatic - you need to press the space bar.
    !

    do i = 1,50
        param = 2.0_pl_test_flt * (i-1)
        ! Create a labelled box to hold the plot.
        ! - this automatically clears the page ...
